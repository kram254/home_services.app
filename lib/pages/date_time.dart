...
import 'package:iNyumbani/pages/home.dart';
...
class _DateAndTimeState extends State<DateAndTime> {
  ...
  final List<dynamic> _exteraCleaning = [
    ['Washing', 'https://img.icons8.com/office/2x/washing-machine.png', '800'],
    ['Fridge', 'https://img.icons8.com/cotton/2x/fridge.png', '200'],
    ['Oven', 'https://img.icons8.com/external-becris-lineal-color-becris/2x/external-oven-kitchen-cooking-becris-lineal-color-becris.png', '200'],
    ['Vehicle', 'https://img.icons8.com/external-vitaliy-gorbachev-blue-vitaly-gorbachev/2x/external-bycicle-carnival-vitaliy-gorbachev-blue-vitaly-gorbachev.png', '600'],
    ['Windows', 'https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/2x/external-window-interiors-kiranshastry-lineal-color-kiranshastry-1.png', '300'],
  ];
                      ...
                      child: FadeAnimation((1.4 + index) / 4, Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5,),
                            Text("+${_exteraCleaning[index][2]} KShs", style: TextStyle(color: Colors.black),)
                          ],
                        )
                      ))
                    );
