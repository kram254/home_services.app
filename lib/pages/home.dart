import 'package:iNyumbani/animation/FadeAnimation.dart';
import 'package:iNyumbani/models/service.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> workers = [
    ['Josh Kamau', 'Plumber', 'https://haajaragroup.com/wp-content/uploads/2021/09/young-happy-black-african-man-construction-worker-UZDXMDM.jpg', 4.8],
    ['Linda Chebet', 'Cleaner', 'https://us.123rf.com/450wm/andreypopov/andreypopov1605/andreypopov160500054/56277190-young-happy-female-janitor-cleaning-induction-stove-with-spray-bottle-in-kitchen.jpg?ver=6', 4.6],
    ['Diana Kalu', 'Driver', 'https://media.istockphoto.com/photos/ensuring-she-has-a-clear-view-picture-id1184421719?k=20&m=1184421719&s=612x612&w=0&h=kcorFVmm9MdsecAF75TsN1DVilF2BD2UooiKZdam4GA=', 4.4],
    ['Brian Omari', 'cleaner', 'https://image.shutterstock.com/image-photo/portrait-young-professional-cleaners-cleaning-260nw-522287203.jpg', 4.6]
  ];
                    ...
                    Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network('https://us.123rf.com/450wm/dolgachov/dolgachov1904/dolgachov190402638/121356050-african-american-woman-with-mop-cleaning-at-home.jpg?ver=6', width: 70,)
                        ),
                        SizedBox(width: 15,),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Magret Awino", style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),),
                            SizedBox(height: 5,),
